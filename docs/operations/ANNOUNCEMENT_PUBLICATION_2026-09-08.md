...
Do not retry the failed X job: it would duplicate the native public post. TikTok's Postiz PUBLISHED state means inbox handoff only, not public publication. Do not post that inbox draft if a native public receipt is recorded below.

## Timing and adaptations

Postiz initially saved a later default time; existing entries were corrected, without creating duplicate entries. Instagram, LinkedIn and TikTok inbox dispatch were at 08:27 UTC. Facebook was dispatched at 08:30 UTC. X was published through the browser after the API failure. This was not an exactly simultaneous five-platform public release.

Instagram/Facebook/TikTok caption:

> القادم يبدأ هنا.
>
> في 11 سبتمبر، تبدأ أورندور فصلها الأول.
> ذكاء اصطناعي وأتمتة ومنتجات رقمية تنطلق من فهم العمل.
>
...
> البداية في 11 سبتمبر.
>
> تستعد أورندور للانطلاق: ذكاء اصطناعي وأتمتة ومنتجات رقمية تبدأ من فهم احتياجات العمل، وتتحول إلى حلول قابلة للاستخدام.
>
...
> القادم يبدأ هنا.
>
> في 11 سبتمبر، تنطلق أورندور: ذكاء اصطناعي وأتمتة ومنتجات رقمية تبدأ من فهم العمل.
>
...
## Supporting Stories and incident

An additional two-channel Story batch was created for 08:43 UTC. Instagram entry `cmtsf7o52000ipv7x22vgcz82` was verified with `post_type=story`. Facebook entry `cmtsf7o4d000hpv7xw20u7soe` unexpectedly retained `post_type=post` after the native dropdown click and was published as a duplicate Reel: https://www.facebook.com/reel/956320846757257 . A keyboard selection subsequently changed the unsaved UI to Story, but the user interacted with Safari before it could be saved and dispatch had already occurred. Do not save or republish that existing entry.
