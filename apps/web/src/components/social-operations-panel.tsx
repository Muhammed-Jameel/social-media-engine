...
export async function SocialOperationsPanel({liveEnabled}:{liveEnabled:boolean}){
 ...
 <p>New task: AURENDOR publishing and first-week learning · hourly. Previous monthly-production task cancelled (paused). The local host must be awake for collection; accepted schedules run in hosted Postiz.</p>
