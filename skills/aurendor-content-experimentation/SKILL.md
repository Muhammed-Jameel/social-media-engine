---
name: aurendor-content-experimentation
description: Design, register, monitor, and evaluate bounded AURENDOR social content experiments with clear variables, KPIs, guardrails, and uncertainty. Use when the calendar deliberately allocates learning capacity.
---

# AURENDOR Content Experimentation
...
Return `ContentExperiment` v1 from `@aurendor/schemas` (`packages/schemas/src/experiments.ts`). Follow [ContentExperiment](../references/output-contracts.md#contentexperiment-packagesschemassrcexperimentsts).
