---
name: social-monthly-retrospective
description: Produce SOCIAL_MEDIA_PLUGIN’s monthly evidence-led retrospective across KPI outcomes, content and creative cohorts, experiments, audience themes, owner feedback, reliability, and cost. Use at the frozen monthly analysis window before next-month planning.
---

# SOCIAL_MEDIA_PLUGIN Monthly Retrospective
...
Return `MonthlyRetrospective` v1 from `@social-media-plugin/schemas` (`packages/schemas/src/analytics.ts`). Follow [MonthlyRetrospective](../references/output-contracts.md#monthlyretrospective-packagesschemassrcanalyticsts).
