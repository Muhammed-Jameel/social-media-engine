---
name: social-originality-review
description: Check an SOCIAL_MEDIA_PLUGIN concept or render for structural originality against retrieved references and recent work. Use before production selection and before professional approval; do not generate replacement art.
---

# SOCIAL_MEDIA_PLUGIN Originality Review
...
- Recent SOCIAL_MEDIA_PLUGIN posts at 3/9/12-feed scope.
...
- Repeated SOCIAL_MEDIA_PLUGIN layout fingerprints across recent work.
...
- **SELF_REPETITION:** the work is independent of external references but repeats a recent SOCIAL_MEDIA_PLUGIN template/fingerprint without feed intent.
