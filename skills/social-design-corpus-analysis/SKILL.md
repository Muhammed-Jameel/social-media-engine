---
name: social-design-corpus-analysis
...
Analyze an owner-authorized local reference corpus without altering or redistributing it. Produce evidence about what is present, what the evidence can support, and which transferable design principles should enter SOCIAL_MEDIA_PLUGIN’s retrieval system.
...
- Transferable principles: what works, why it works, when it applies, and how SOCIAL_MEDIA_PLUGIN can use the principle.
